...
public class Server{
    ...
    public Server(String[] arr)
    {
    	...
    	this.avbCore = this.core;
    	this.avbMemory = this.memory;
    	this.avbDsk = this.dsk;
    }
    ...
    public boolean compareAnotherJob(Job j)
    {
    	if(j.core <= this.avbCore && j.memory <=this.avbMemory && j.dsk <= this.avbDsk)
    		return true;
    	return false;
    }
}
